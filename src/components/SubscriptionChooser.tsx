          ...
          {subs.map((s) => {
            ...
            return (
              ...
              >
                ...
                <span className="ml-4 flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[color:var(--color-bold-yellow)] text-[color:var(--color-lit-grey)] transition group-hover:scale-105">
