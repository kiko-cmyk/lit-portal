...
<body>
  <nav class="portal-nav">
    <a href="/apps/mi-portal${tokenParam}">Inicio</a>
    <a href="/apps/mi-portal/suscripciones${tokenParam}">Suscripciones</a>
    <a href="/apps/mi-portal/recompensas${tokenParam}">Recompensas</a>
    <a href="/apps/mi-portal/referidos${tokenParam}">Referidos</a>
    <a href="/apps/mi-portal/pedidos${tokenParam}">Pedidos</a>
    <a href="/apps/mi-portal/contenido${tokenParam}">Contenido</a>
  </nav>
